...
eQTL="/lustre/scratch123/hgi/projects/bhf_finemap/coloc/pipeline/work/d7/bebaba5170f4ab20137bc9ea41c761/Microglia.16.gz"
GWAS="/lustre/scratch123/hgi/projects/bhf_finemap/summary_stats/White_matter_hyperintensities/GWAS_UKB_logWMHnorm.txt"
print('eQTL')
print(eQTL)
print('GWAS')
print(GWAS)
